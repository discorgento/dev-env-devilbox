...
installenv(){
    ...
    cd ~/devilbox/
    wget -c https://raw.githubusercontent.com/Discorgento/dev-env-devilbox/main/devilbox/.env
    wget -c https://raw.githubusercontent.com/Discorgento/dev-env-devilbox/main/devilbox/docker-compose.override.yml
    mkdir sh
    cd ~/devilbox/sh
    wget -c https://raw.githubusercontent.com/Discorgento/dev-env-devilbox/main/devilbox/sh/docker-entrypoint-es.sh
    cd ~/devilbox/bash/
...
aliases(){
    ...
    then
        ...
        cd ~
        wget -c https://raw.githubusercontent.com/Discorgento/dev-env-devilbox/main/devilbox/.aliases
        echo "***Aliases added"
    else
