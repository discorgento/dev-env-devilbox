...
alias startproj='n98 db:import mage_${PWD##*/}_$(date +"%d-%m-%Y").sql.gz --optimize -v && n98urlbaseset && mgbm app:config:import && mgbm config:set catalog/search/elasticsearch7_server_hostname "172.16.238.240" && mgdev && mgir && mgsu'
alias grun='grunt clean && grunt exec && grunt less && grunt watch'
alias mgcp='./vendor/bin/ece-tools apply'
